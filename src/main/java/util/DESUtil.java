...
public class DESUtil {
	...
	public static void main(String[] args) throws Exception {
		...
		new DESUtil();
		System.out.println(DESUtil.encrypt(System.currentTimeMillis()+"s6677676"));
		
		String reqToken= "121440c32eddb9fb7d23119a5969491abcda0a1359e2b4fd";
		String decryptStr =  new DESUtil().decrypt(reqToken);
	...
	public String getToken(String requestToken) {
		...
		if(null != requestToken && !"".equals(requestToken)){
			try {
				new DESUtil();
				String decryptStr =  DESUtil.decrypt(requestToken);
				String token = decryptStr.split(",")[0];
				Long originTime = Long.valueOf(decryptStr.split(",")[1]);
